...
function OAuthProviderButton({
  ...
  const Button = OAUTH_BUTTON_MAP[provider]
  const isActive = isLoading === provider
...
const GITHUB_ICON = (
  <svg viewBox="0 0 24 24" fill="#24292E" width={20} height={20}>
...
export function AuthForm() {
  ...
  return (
    <Root>
      <TextCenter>
        <GradientTitle>Welcome back</GradientTitle>
        <SubText>Sign in to your account</SubText>
      </TextCenter>

      <AuthCard>
        <AuthCardHeader>
          <AuthCardTitle>Sign in with</AuthCardTitle>
          <CardDescription>
